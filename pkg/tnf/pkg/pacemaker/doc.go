...
//     "pcs status xml" and storing the results in a PacemakerStatus custom resource. The collector
...
//
//  2. Health Check Controller (healthcheck.go): Monitors the PacemakerStatus CR and evaluates
